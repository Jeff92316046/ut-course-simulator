...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('academic_year_semester', 'course_code', 'class_name', 'college', 'name', name='uix_course_identity')
    )
    op.create_index(op.f('ix_courses_academic_year_semester'), 'courses', ['academic_year_semester'], unique=False)
    op.create_index(op.f('ix_courses_class_name'), 'courses', ['class_name'], unique=False)
    ...
    sa.Column('week_pattern', sa.Enum('EVERY_WEEK', 'ODD_WEEKS', 'EVEN_WEEKS', name='weekpatternenum'), nullable=False),
    sa.ForeignKeyConstraint(['course_id'], ['courses.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_course_schedules_id'), 'course_schedules', ['id'], unique=False)
    op.create_table('course_tables',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_course_tables_academic_year_semester'), 'course_tables', ['academic_year_semester'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_course_tables_academic_year_semester'), table_name='course_tables')
